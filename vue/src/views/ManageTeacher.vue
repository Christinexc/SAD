<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="header">
      ...
      <el-table-column prop="phone" label="擅长领域">
      </el-table-column>
      <el-table-column prop="address" label="职称">
      </el-table-column>

      <el-table-column label="操作"  width="400"  v-if="this.user.role=== 'ROLE_MANAGER'">
      ...
      <el-table-column label="操作"  width="400"  v-if="this.user.role=== 'ROLE_EXECUTOR'">
        <template  slot-scope="scope">
...
export default {
  ...
  methods:{
    ...
    load()
    {
        ...
        this.request.get("/user/role/page",{
          params:{
            pageNum:this.pageNum,
            pageSize:this.pageSize,
            roleId: String(7) ,
